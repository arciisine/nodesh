...
declare global {
  interface AsyncGenerator<T = unknown, TReturn = any, TNext = unknown> {
    ...
    columns<V extends readonly string[]>(
      this: AsyncGenerator<string, TReturn, TNext>, names: V, sep?: RegExp | string
     ...
     */
    columns(this: AsyncGenerator<string, TReturn, TNext>, sep?: RegExp | string): AsyncGenerator<T[], TReturn, TNext>;
    /**
     * This operator allows for producing a single sequence of tokens out of lines of text.  The default separator is whitespace.
     */
    tokens(this: AsyncGenerator<string, TReturn, TNext>, sep?: RegExp | string): AsyncGenerator<T, TReturn, TNext>;
    /**
     ...
     */
    match(this: AsyncGenerator<string, TReturn, TNext>, regex: RegExp | string | RegexType, mode?: MatchMode): AsyncGenerator<string, TReturn, TNext>;
    /**
     * Behaves identically to `String.prototype.replace`, but will only operate on a single generator value at a time.
     */
    replace(this: AsyncGenerator<string, TReturn, TNext>, regex: RegExp | string, sub: string | Replacer): AsyncGenerator<string, TReturn, TNext>;
    /**
     * Behaves identically to `String.prototype.trim`, but will only operate on a single generator value at a time.
     */
    trim(this: AsyncGenerator<string, TReturn, TNext>): AsyncGenerator<string, TReturn, TNext>;
    /**
     ...
     */
    singleLine(this: AsyncGenerator<string, TReturn, TNext>): AsyncGenerator<string, TReturn, TNext>;
    /**
     * This operator allows for combining a sequence of strings into a single value similar to `String.prototype.join`.
     */
    join(this: AsyncGenerator<string, TReturn, TNext>, joiner?: string | ((a: string[]) => string)): AsyncGenerator<string, TReturn, TNext>;
  }
}
